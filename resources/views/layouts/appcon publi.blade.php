...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="text-light"><span style=" color: #d9232d;">{{ config('app.name', 'Compuagenda') }}</span></h1>
      </div>
        ...
        <div class="col-md-4">
          ...
          <!-- Search Widget -->
           <div class="sidebar">
              ...
              <h3 class="sidebar-title">Publicidad</h3>
          ...
          <!-- Categories Widget -->
           <div class="sidebar">
             <h3 class="sidebar-title">Categorias más buscadas</h3>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <div class="footer-info">
                          ...
                          <p>
                               ...
                               <i class="icofont-envelope"> </i> <strong>Email:</strong><a href="mailto:soporte@compuagenda.com">soporte@compuagenda.com</a> <br></p> 
                            </div>
